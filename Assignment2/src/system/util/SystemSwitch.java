...
public class SystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SystemPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.BOOLEAN_CONDITION: {
				BooleanCondition booleanCondition = (BooleanCondition)theEObject;
				T result = caseBooleanCondition(booleanCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.WORK_PIECE: {
				WorkPiece workPiece = (WorkPiece)theEObject;
				T result = caseWorkPiece(workPiece);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.STEP: {
				Step step = (Step)theEObject;
				T result = caseStep(step);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.MANUFACTURING: {
				Manufacturing manufacturing = (Manufacturing)theEObject;
				T result = caseManufacturing(manufacturing);
				if (result == null) result = caseStep(manufacturing);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.QUALITY_ASSURANCE: {
				QualityAssurance qualityAssurance = (QualityAssurance)theEObject;
				T result = caseQualityAssurance(qualityAssurance);
				if (result == null) result = caseStep(qualityAssurance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.TRANSPORT: {
				Transport transport = (Transport)theEObject;
				T result = caseTransport(transport);
				if (result == null) result = caseStep(transport);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.IMS: {
				IMS ims = (IMS)theEObject;
				T result = caseIMS(ims);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.STORAGE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Manufacturing</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Manufacturing</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseManufacturing(Manufacturing object) {
		return null;
	}
