 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='threeThereShallNotExist'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot threeThereShallNotExist='\n\t\tself.consistsOf->selectByKind(Step).oclAsType(ManufacturingSystemElement).responsible->excludes(self.responsible)'"
 * @generated
 */
