 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='fiveTransitionShallOnlyConnect'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot fiveTransitionShallOnlyConnect='\n\t\tManufacturingSystem.allInstances()->select(consistsOf->includes(self)).ManufacturingSystem::consistsOf->includesAll(self.transition)'"
 * @generated
 */
