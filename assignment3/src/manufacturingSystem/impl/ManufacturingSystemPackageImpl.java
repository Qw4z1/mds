...
public class ManufacturingSystemPackageImpl extends EPackageImpl implements ManufacturingSystemPackage {
	...
	public static ManufacturingSystemPackage init() {
		...
		ManufacturingSystemPackageImpl theManufacturingSystemPackage = (ManufacturingSystemPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ManufacturingSystemPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ManufacturingSystemPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getCompositeStep_Contains() {
	...
	public void createPackageContents() {
		...
		createEReference(compositeStepEClass, COMPOSITE_STEP__CONTAINS);
	...
	public void initializePackageContents() {
		...
		compositeStepEClass.getESuperTypes().add(this.getStep());
		...
		initEReference(getCompositeStep_Contains(), this.getManufacturingSystem(), null, "contains", null, 1, 1, CompositeStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (manufacturingSystemEClass, 
		   source, 
		   new String[] {
			 "constraints", "threeThereShallNotExist"
		   });	
		addAnnotation
		  (stepEClass, 
		   source, 
		   new String[] {
			 "constraints", "oneResponsible sevenOutputInputs nineForEachStep"
		   });	
		addAnnotation
		  (responsibleEClass, 
		   source, 
		   new String[] {
			 "constraints", "secondEachResponsibleThree"
		   });	
		addAnnotation
		  (storagePointEClass, 
		   source, 
		   new String[] {
			 "constraints", "fourNoStartStorage fiveNoEndStorage"
		   });	
		addAnnotation
		  (manufacturingSystemElementEClass, 
		   source, 
		   new String[] {
			 "constraints", "fiveTransitionShallOnlyConnect"
		   });	
		addAnnotation
		  (compositeStepEClass, 
		   source, 
		   new String[] {
			 "constraints", "eightForCompositeSteps"
		   });
	}
