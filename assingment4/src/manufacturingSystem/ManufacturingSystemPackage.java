...
public interface ManufacturingSystemPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://com.chalmers.manufacturingSystem";
	 ...
	 * @generated
	 */
	String eNS_PREFIX = "manufacturingSystem";
	...
	/**
	 * The meta object id for the '{@link manufacturingSystem.impl.CompositeStepImpl <em>Composite Step</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see manufacturingSystem.impl.CompositeStepImpl
	 * @see manufacturingSystem.impl.ManufacturingSystemPackageImpl#getCompositeStep()
	 * @generated
	 */
	int COMPOSITE_STEP = 10;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__TRANSITION = STEP__TRANSITION;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__NAME = STEP__NAME;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__RESPONSIBLE = STEP__RESPONSIBLE;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__SPEED = STEP__SPEED;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__INPUT = STEP__INPUT;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__OUTPUT = STEP__OUTPUT;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP__CONTAINS = STEP_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP_FEATURE_COUNT = STEP_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int COMPOSITE_STEP_OPERATION_COUNT = STEP_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link manufacturingSystem.CompositeStep <em>Composite Step</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Composite Step</em>'.
	 * @see manufacturingSystem.CompositeStep
	 * @generated
	 */
	EClass getCompositeStep();

	/**
	 * Returns the meta object for the containment reference '{@link manufacturingSystem.CompositeStep#getContains <em>Contains</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Contains</em>'.
	 * @see manufacturingSystem.CompositeStep#getContains()
	 * @see #getCompositeStep()
	 * @generated
	 */
	EReference getCompositeStep_Contains();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link manufacturingSystem.impl.CompositeStepImpl <em>Composite Step</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see manufacturingSystem.impl.CompositeStepImpl
		 * @see manufacturingSystem.impl.ManufacturingSystemPackageImpl#getCompositeStep()
		 ...
		 * @generated
		 */
		EReference COMPOSITE_STEP__CONTAINS = eINSTANCE.getCompositeStep_Contains();
